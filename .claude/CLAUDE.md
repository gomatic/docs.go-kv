# `docs.go-kv` — public documentation repository

This is the **public** documentation site for [`gomatic/go-kv`](https://github.com/gomatic/go-kv), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-kv`](https://github.com/gomatic/go-kv)'s API changes, update [`content/`](../content/) to match.
